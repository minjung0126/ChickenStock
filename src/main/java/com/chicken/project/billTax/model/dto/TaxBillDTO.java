...
public class TaxBillDTO {
    ...
    public TaxBillDTO(int taxNo, String itemName, String itemStandard, int orderAmount, int itemSales, Date orderDate, Date taxDate, String storeNo, String storeName, String storeAddress) {
        this.taxNo = taxNo;
